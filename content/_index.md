...
**Key contributions:**
- Architected and executed a full on-premises-to-cloud migration, enabling hybrid and remote work at scale
- Led a company-wide POTS-to-VoIP phone system replacement from vendor selection through go-live
- Built Tableau and Python BI dashboards that are now central to operational reporting
- Developed a C# Excel automation tool that processes thousands of client lists with minimal manual input
- Administer Windows Server, Linux, AWS, VMware, Active Directory, and VoIP infrastructure daily
- Develop and maintain WordPress and Drupal websites in PHP
...
**Responsibilities:**
- Gameplay and systems programming in C++ and Unreal Engine Blueprints
- Game and puzzle design, contributing to the overall player experience
- DevOps administration, including build pipelines and version control
...
- Internal tooling and editor extensions for the content team
- Character animation controllers and state machine logic
- AI behaviour systems for non-player characters
